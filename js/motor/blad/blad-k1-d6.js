/* FAMILJ A · ARBETSSIDANS MOTOR — ak7-k1-d6-multiplikation.html
...
var FORELASNINGAR = [
  {id:'a1VbnML4Q_M', titel:'Multiplikation med stora tal',         tag:'Föreläsning'},
  {id:'Ahtpc80E_wk', titel:'Multiplikation med små tal',           tag:'Föreläsning'},
  {id:'EocXr32R-jY', titel:'Multiplikation med stora och små tal', tag:'Föreläsning'}
];
...
var GENERATORER = {
  ...
  storasma:    { gen: generera_BLAD_STORASMA,    grund: GRUND_BLAD_STORASMA }
};
...
byggSheet('storasma',    'A', true);
bygg_blad(document.getElementById('sheet-problem'), GRUND_BLAD_PROBLEM);