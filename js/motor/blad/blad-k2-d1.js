...
(function(){
  ...
  // Figurgeneratorerna bor i den delade modulen js/motor/figur/svg-andel.js (flytta och dela).
  var F = window.SvgAndel || {};
  var C_LINE=F.C_LINE, C_FILL=F.C_FILL, C_RED=F.C_RED, C_GREEN=F.C_GREEN, C_PAPER=F.C_PAPER, C_MARK=F.C_MARK, svg=F.svg;
  var delRuta=F.delRuta, delKryss=F.delKryss, delAtta=F.delAtta, delCirkel=F.delCirkel, delTriangel4=F.delTriangel4,
      delHexagon=F.delHexagon, delStrip=F.delStrip, hackKvadrat=F.hackKvadrat, olikStrip=F.olikStrip,
      ratTriKvart=F.ratTriKvart, diagKvadratAtta=F.diagKvadratAtta, tallinje=F.tallinje, antalsfigur=F.antalsfigur,
      husFigur=F.husFigur, LFigur=F.LFigur;
