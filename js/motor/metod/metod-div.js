...
function renderDivGata(body, backFn){
  ...
  function render(){
    ...
    body.innerHTML = '<div class="exercise-card">'
      ...
      + '</div>'
      + '<div class="rakna-svar-rad"><input type="text" class="rakna-svar-input" id="gata-input" inputmode="numeric" maxlength="3" autocomplete="off"></div>'
    ...
    body.innerHTML = '<div class="exercise-card">'
      ...
      + '<div class="div-forlang-rad">'
        ...
        + '<span class="div-forlang-brak">'
          + '<input type="text" class="rakna-svar-input div-forlang-in" id="dfl-ft" inputmode="text" maxlength="10" autocomplete="off">'
          + '<span class="div-forlang-streck"></span>'
          + '<input type="text" class="rakna-svar-input div-forlang-in" id="dfl-fn" inputmode="text" maxlength="10" autocomplete="off">'
        + '</span>'
        + '<span class="div-forlang-lika">=</span>'
        + '<input type="text" class="rakna-svar-input div-forlang-svar" id="dfl-sv" inputmode="text" maxlength="12" autocomplete="off">'
      + '</div>'
