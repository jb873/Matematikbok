...
(function(){
  ...
  function genArea(level){
    var bank = byLevel(level,
      [[2,'dm'],[3,'dm'],[4,'dm'],[5,'dm']],
      [[6,'dm'],[7,'dm'],[8,'dm'],[20,'cm'],[30,'cm']],
      [[40,'cm'],[0.2,'m'],[0.3,'m'],[0.5,'m']]);
  ...
  function genSkala(level){
    var N = pick([11, 12, 13, 14, 15]), sq = N * N;
    var vlist = byLevel(level, [N / 10], [N * 10], [N / 100]);
  ...
  function genSida(level){
    var bank = byLevel(level,
      [[9,'cm'],[16,'cm'],[25,'cm'],[36,'cm'],[49,'cm'],[64,'cm']],
      [[81,'cm'],[100,'cm'],[400,'cm'],[900,'dm']],
      [[0.81,'m']]);
  ...
  function genDecimal(level){
    var bank = byLevel(level,
      [[0.04,0.2],[0.09,0.3],[0.16,0.4],[0.25,0.5]],
      [[0.36,0.6],[0.49,0.7],[0.64,0.8],[0.81,0.9]],
      [[1.44,1.2],[0.01,0.1],[1600,40]]);
    var b = pick(bank);
  ...
  function renderKvrotDrill(body, cfg){
    ...
    function genOmgang(){ var o = []; for(var i = 0; i < 8; i++) o.push(cfg.gen(level)); return o; }
